 ...
 */
export function draw(gl, programInfo, addPadding, model, modelTexture, glintTexture) {
    // Reset canvas
    ...
    // Draw enchantment glint (See Minecraft v1.8.9 RenderItem#renderEffect(IBakedModel))
    if (!glintTexture) {
        return;
    }
