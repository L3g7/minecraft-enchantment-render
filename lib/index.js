...
export function createMultiRenderer(canvas, models, contextAttributes) {
    if (sharedRenderers.has(canvas.width)) {
        let sharedRenderersH = sharedRenderers.get(canvas.width);
        if (sharedRenderersH.has(canvas.height)) {
            return new BlitRenderer(canvas, contextAttributes, sharedRenderersH.get(canvas.height), models);
        }
    }
...
class WebGLRenderer extends Renderer {
    ...
    constructor(canvas, contextAttributes, models) {
        ...
        console.log("Created WebGLRenderer");
        this.gl = gl;
...
class BlitRenderer extends Renderer {
    ...
    constructor(canvas, contextAttributes, renderer, models) {
        ...
        console.log("Created BlitRenderer");
    }
